...
import ChartSeries from 'Frontend/generated/com/newsrx/jam/views/dashboard/ChartSeries';
import HealthGridItem from 'Frontend/generated/com/newsrx/jam/views/dashboard/HealthGridItem';
...
export class DashboardView extends View {
  ...
  @state()
  private statusColumnRenderer: GridBodyRenderer = this.renderStatusColumn.bind(this);
